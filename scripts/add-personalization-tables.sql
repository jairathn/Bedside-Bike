...
CREATE TABLE IF NOT EXISTS mobility_scores (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    patient_id INTEGER NOT NULL REFERENCES users(id),
    score_timestamp INTEGER NOT NULL,
    bike_performance_score REAL NOT NULL,
    ambulation_score REAL,
    pt_assessment_score REAL,
    nursing_observation_score REAL,
    adl_function_score REAL,
    unified_mobility_score REAL NOT NULL,
